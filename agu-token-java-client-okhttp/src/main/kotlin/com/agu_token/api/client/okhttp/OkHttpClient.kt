...
import com.agu_token.api.core.http.HttpClient
import com.agu_token.api.core.http.HttpMethod
import com.agu_token.api.core.http.HttpRequest
import com.agu_token.api.core.http.HttpRequestBody
import com.agu_token.api.core.http.HttpResponse
import com.agu_token.api.errors.AguTokenIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw AguTokenIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(AguTokenIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("AGU_TOKEN_LOG")?.lowercase()) {
