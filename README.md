...
[![Maven Central](https://img.shields.io/maven-central/v/com.agu_token.api/agu-token-java)](https://central.sonatype.com/artifact/com.agu_token.api/agu-token-java/0.0.1-alpha.2)
[![javadoc](https://javadoc.io/badge2/com.agu_token.api/agu-token-java/0.0.1-alpha.2/javadoc.svg)](https://javadoc.io/doc/com.agu_token.api/agu-token-java/0.0.1-alpha.2)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.agu_token.api/agu-token-java/0.0.1-alpha.2).
...
```kotlin
implementation("com.agu_token.api:agu-token-java:0.0.1-alpha.2")
```
