...
class AguTokenClientAsyncImpl(private val clientOptions: ClientOptions) : AguTokenClientAsync {
    ...
    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): AguTokenClientAsync =
        AguTokenClientAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
