...
/**
 * A client for interacting with the Agu Token REST API asynchronously. You can also switch to
...
interface AguTokenClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): AguTokenClientAsync
    ...
    /**
     * A view of [AguTokenClientAsync] that provides access to raw HTTP responses for each method.
     */
