package com.agu_token.api.core.http
...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        // Only retry IOException and AguTokenIoException, other exceptions are not intended to be
        // retried.
        throwable is IOException || throwable is AguTokenIoException
