...
import com.agu_token.api.core.MultipartField
    ...
    object : HttpRequestBody {
        ...
        private fun serializePart(
            ...
            when (node.nodeType) {
                            ...
                            node
                                ...
                                .mapNotNull { element ->
                                    when (element.nodeType) {
                                        ...
                                        JsonNodeType.OBJECT,
                                        JsonNodeType.POJO ->
                                            throw AguTokenInvalidDataException(
                ...
                JsonNodeType.POJO,
                null ->
                    throw AguTokenInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
            }
